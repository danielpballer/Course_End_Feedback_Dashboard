---
title: "Course End Feedback Dashboard"
output: 
...
num_data = read_csv("MATH_SurveyData_USMA-WP_2022_2022-2_Standard_Numerics_20220516104559_EM20N2N2K-NO-SECTION-ID.csv")

#update the name of the file containing free text responses
comment_data = read_csv("MATH_SurveyData_USMA-WP_2022_2022-2_Standard_Comments_20220516104559_EM20N2N2K-NO-SECTION-ID.csv") 
...
```{r render subpages by course, include=FALSE}
